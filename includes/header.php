...
<head>
    ...
    <link rel="stylesheet" href="css/<?= htmlspecialchars($pageCss) ?>?v=21.0">
    <?php else: ?>
    <link rel="stylesheet" href="css/index.css?v=21.0">
    <?php endif; ?>
    <link rel="stylesheet" href="css/global.css?v=21.0">
