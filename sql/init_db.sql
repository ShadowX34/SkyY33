...
('ДЕНЬ РОЖДЕНИЯ - СКИДКА 10%', 'Предъяви паспорт и получи скидку 10% в свой день рождения!', '-10%', 'Получить скидку', 'Действует в течение 3 дней до и после дня рождения;Распространяется на все виды прыжков;Не суммируется с другими акциями;Дополнительные привилегии', 'images/stocks/скидка.webp', 1, 10),
('СКИДКА 500₽ В БУДНИЙ ДЕНЬ', 'Специальное предложение для тех, кто может прыгать в будни!', '-500₽', 'Записаться в будний день', 'Действует по четвергам в дни проведения прыжков;Не распространяется на выходные и праздники;При покупке сертификата скидка фиксируется;Дополнительные привилегии', 'images/stocks/скидка2.webp', 1, 20),
...
('НОВОГОДНИЕ СКИДКИ НА ПОДАРОЧНЫЕ СЕРТИФИКАТЫ', 'Зима — это по-настоящему волшебное время, когда всё вокруг превращается в сказку...', '2024-12-05', 'images/news/СЕЗОН 2025.webp', 1),
