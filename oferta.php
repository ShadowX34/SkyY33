...
<main class="about-page" style="margin-top: 100px; position: relative; z-index: 10; padding: 40px 15px;">
    <div class="about-container"
        ...
        <!-- 3. Срок действия -->
        <div style="margin-bottom: 40px;">
            <h2 style="color: #216dbd; font-size: 1.4rem; margin: 0 0 15px;">3. Срок действия Договора</h2>
            <p style="margin-bottom: 0;"><strong>3.1.</strong> Договор вступает в силу со дня акцепта заказчиком и действует до полного исполнения сторонами обязательств по Договору.</p>
        </div>
        ...
        <div style="margin-bottom: 40px;">
            <h2 style="color: #216dbd; font-size: 1.4rem; margin: 0 0 15px;">5. Права и обязанности</h2>

            <h3 style="color: #333; font-size: 1.1rem; margin: 0 0 10px;">5.1. Исполнитель обязуется:</h3>
            <ul style="padding-left: 20px; margin-bottom: 20px; list-style: none;">
                <li style="margin-bottom: 10px;"><strong>5.1.1.</strong> Оказать Заказчику услуги надлежащего качества в надлежащем объеме и в согласованные Сторонами сроки.</li>
                <li style="margin-bottom: 10px;"><strong>5.1.2.</strong> Обеспечить полную сохранность предоставленных Заказчиком данных, материалов, а также конфиденциальность информации, полученной им в процессе оказания услуг.</li>
            </ul>

            <h3 style="color: #333; font-size: 1.1rem; margin: 0 0 10px;">5.2. Исполнитель имеет право:</h3>
            <ul style="padding-left: 20px; margin-bottom: 20px; list-style: none;">
                <li style="margin-bottom: 10px;"><strong>5.2.1.</strong> Получать от Заказчика необходимые данные и информацию для оказания услуг и полагаться на них без дополнительной проверки.</li>
                <li style="margin-bottom: 10px;"><strong>5.2.2.</strong> При необходимости привлекать к исполнению услуг сторонних специалистов и экспертов.</li>
            </ul>

            <h3 style="color: #333; font-size: 1.1rem; margin: 0 0 10px;">5.3. Заказчик обязуется:</h3>
            <ul style="padding-left: 20px; list-style: none;">
                <li style="margin-bottom: 10px;"><strong>5.3.1.</strong> Предоставить Исполнителю любые необходимые и достоверные данные и информацию для оказания услуг.</li>
                <li style="margin-bottom: 10px;"><strong>5.3.2.</strong> Своевременно и полностью оплатить услуги Исполнителя.</li>
            </ul>
        </div>

        <!-- 6. Расторжение -->
        <div style="margin-bottom: 40px;">
            <h2 style="color: #216dbd; font-size: 1.4rem; margin: 0 0 15px;">6. Основания и порядок расторжения Договора</h2>
            <p style="margin-bottom: 12px;"><strong>6.1.</strong> После оформления и оплаты заказа Заказчик имеет право отказаться от услуг Исполнителя и запросить возврат денег, направив письменное уведомление «Отказ от предоставления услуг» на адрес электронной почты <a href="mailto:vlad-skyclub@yandex.ru" style="color: #216dbd; text-decoration: underline;"><strong>vlad-skyclub@yandex.ru</strong></a>.</p>
            <p style="margin-bottom: 0;"><strong>6.2.</strong> Исполнитель вправе удержать из уплаченной Заказчиком суммы стоимость уже оказанных услуг на момент получения уведомления об отказе.</p>
        </div>

        <!-- 7. Разрешение споров -->
        <div style="margin-bottom: 40px;">
            <h2 style="color: #216dbd; font-size: 1.4rem; margin: 0 0 15px;">7. Разрешение споров</h2>
            <p style="margin-bottom: 12px;"><strong>7.1.</strong> Споры и разногласия по вопросам исполнения Договора разрешаются на переговорах.</p>
            <p style="margin-bottom: 0;"><strong>7.2.</strong> Если на переговорах Стороны не смогут достичь согласия, спор передается в суд.</p>
        </div>
        ...
        <div style="margin-bottom: 0;">
            ...
            <div style="background: #f7f9fc; border-left: 4px solid #216dbd; border-radius: 8px; padding: 25px 30px; line-height: 2;">
                ...
                <p style="margin: 0 0 5px;"><strong>КПП:</strong> 332701001</p>
                <p style="margin: 0 0 5px;"><strong>Банк:</strong> Владимирское отделение № 8611 СБ РФ г. Владимир</p>
                <p style="margin: 0 0 5px;"><strong>Расчётный счёт:</strong> 40703810410040100504</p>
                <p style="margin: 0 0 5px;"><strong>Корр. счёт:</strong> 30101810000000000602</p>
                <p style="margin: 0 0 5px;"><strong>БИК:</strong> 041708602</p>
                <p style="margin: 20px 0 0;"><strong>Начальник</strong> &nbsp;&nbsp; ___________________ В.В.Трынов</p>
            </div>
        </div>
