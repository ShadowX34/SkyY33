...
const authorNames = {
  ...
  '2.png': 'Вера Сырова',
  '3.png': 'Ксения',
  '4.png': 'Николай Гришин',
  '5.png': 'Анастасия',
  '6.png': 'Любовь Триханова',
  '7.png': 'Ася Бесчастнова',
  '8.png': 'Дарина Садикова',
  '9.png': 'Князева Елена',
  '10.png': 'Анна Беляева',
  '11.png': 'Григорий Перов',
  '12.png': 'Кристина',
  '13.png': 'Коробов Валерий',
  '14.png': 'Князева Елена',
  '15.png': 'Ольга Большакова',
  '16.png': 'Юлия Голованова',
  '17.png': 'Денис Кононов',
  '18.png': 'Ирина Дмитриевна',
  '19.png': 'Татьяна Лапшина',
  '20.png': 'Андрей Прокопов',
  '21.png': 'Антон Афанасьев',
  '22.png': 'Олеся Смирнова',
  '23.png': 'Светлана Щукина',
  '24.png': 'Марина Евсеева',
  '25.png': 'Светлана Андреева'
}

// Резервные тексты (как было в оригинальном reviews.php)
const fallbackTexts = {
  '1.png': 'Если вы еще не прыгали с парашютом, то многое потеряли. Это незабываемые впечатления, крутой подарок и красота нереальная! Прыгали с сыном в разные дни. Фото абсолютно разные! С нашими инструкторами бояться нечего!!! Очень внимательные и ответственные!',
  '2.png': 'Даааа!!!! Я это сделала! Представь, летишь с парашютом и думаешь: а вдруг не раскроется? Страшно. Дышать трудно. Сердце между лопаток. А все равно восторг. Раскрылся — и снова счастье.',
  '3.png': 'Это был незабываемый день. Это так здорово, это ни с чем не сравнимо! Спасибо вам за слаженную работу и за мои эмоции!',
  '4.png': 'Это было незабываемо.',
  '5.png': 'С детства очень хотелось, долго не решалась — и вот наконец-то. Это такой кайф, особенно свободное падение. Было мало — хочу ещё!'
}
  ...
  try {
    ...
    sliders.value = allReviews
      ...
      .map(r => ({
        ...
        review_text: r.review_text || fallbackTexts[r.image] || 'Отдыхали на аэродроме, очень понравилось! Рекомендуем.',
    ...
    if (sliders.value.length === 0) {
      sliders.value = [
        ...
        { imageUrl: '/images/reviews/2.png', author_name: 'Вера Сырова', review_text: 'Даааа!!!! Я это сделала! Представь, летишь с парашютом и думаешь: а вдруг не раскроется? Страшно. Дышать трудно. Сердце между лопаток. А все равно восторг. Раскрылся — и снова счастье.' }
      ]
    }
